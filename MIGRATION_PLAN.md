...
- **Multiscale modeling:** Implemented as `ms_agent_ratio` (per-agent cancer-pathway resolution; default `1` = off). See `docs/superpowers/specs/2026-05-28-multiscale-agents-design.md`.
