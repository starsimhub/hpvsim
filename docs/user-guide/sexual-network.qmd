...
HPVsim ships demographic data per country but not network parameters, so the defaults above are location-agnostic starting points. Supplying local behavioral data is the highest-value change you can make to a country model.
